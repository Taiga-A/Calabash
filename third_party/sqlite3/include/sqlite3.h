...
SQLITE3_H
#include
<stdarg.h>     /* Needed for the definition of va_list */
...
#else
# define
sqlite3_compileoption_used(X) 0
# define
sqlite3_compileoption_get(X)  ((void*)0)
#endif
...
#define
SQLITE_TESTCTRL_LAST                    33  /* Largest TESTCTRL */
...
SQLITE_OMIT_WAL
# define
SQLITE_OMIT_WAL 1/* because it requires shared memory APIs */
# ifndef
